            ...
            if line_curr[0] != '--' and line_prev[0] != '--' and line_next[0] != '--':
                if (line_curr[5]== 'chrM' and line_prev[5]!='chrM'):
                    if (line_curr[0][:-12]==line_prev[0][:-12]):
                        if line_curr[4] == '+':
                            save=save+line_curr[5]+" "+line_curr[7]
                            if line_prev[4] == "+":
                                save= save + " " +line_prev[5] + " " + line_prev[8]
                            elif line_prev[4] == "-":
                                save = save + " " + line_prev[5] + " " + line_prev[7]
                        elif line_curr[4] == '-':
                            save=save+line_curr[5]+" "+line_curr[8]
                            if line_prev[4] == "+":
                                save = save + " " + line_prev[5] + " " + line_prev[8]
                            elif line_prev[4] == "-":
                                save = save + " " + line_prev[5] + " " + line_prev[7]
                    ...
                    if (line_curr[0][:-12] == line_next[0][:-12]):
                        if line_curr[4] == '-':
                            save = save + line_curr[5] + " " + line_curr[7]
                            if line_next[4] == "+":
                                save = save + " " + line_next[5] + " " + line_next[7]
                            elif line_next[4] == "-":
                                save = save + " " + line_next[5] + " " + line_next[8]
                        elif line_curr[4] == '+':
                            save = save + line_curr[5] + " " + line_curr[8]
                            if line_next[4] == "+":
                                save = save + " " + line_next[5] + " " + line_next[7]
